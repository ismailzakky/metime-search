package com.cus.metime.search;

import com.cus.metime.search.client.OAuth2InterceptedFeignConfiguration;
import com.cus.metime.search.config.ApplicationProperties;
import com.cus.metime.search.config.DefaultProfileUtil;
...
public class SearchApp {
    ...
    public SearchApp(Environment env) {
        this.env = env;
    }
